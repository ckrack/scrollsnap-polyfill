var scrollsnap = (function(w, doc, undefined) {
  // Enable strict mode
  'use strict';
  ...
  /**
   * Feature detect scroll-snap-type
   */
   ...
   */
  var setupElement = function(obj, declaration) {
  ...
  function getNextSnapPoint(scrollObj, obj, declaration, direction) {
    if (DEBUG) console.log('[Scrollsnap] get next snap point: ', scrollObj, obj, declaration);
    ...
    if (DEBUG) console.log('[Scrollsnap] initial point: '+initialPoint);
    if (DEBUG) console.log('[Scrollsnap] current point: '+currentPoint);
    if (DEBUG) console.log('[Scrollsnap] direction: '+direction);
    if (DEBUG) console.log('[Scrollsnap] current point ceiled: '+Math.ceil(currentPoint));
